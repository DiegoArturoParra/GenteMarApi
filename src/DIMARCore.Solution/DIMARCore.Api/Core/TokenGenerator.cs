...
namespace DIMARCore.Api.Core
{
    ...
    public static class TokenGenerator
    {
        ...
        public static string GenerarTokenJwt(UserSesionDTO usuario)
        {
            ...
            {
                new Claim(ClaimTypes.Sid, EncryptDecryptService.EncryptWithSaltHash(usuario.LoginId.ToString(),ConfigurationManager.AppSettings[Constantes.KEY_ENCRYPTION_WITHOUT_HASH].ToString())),
                ...
                new Claim(ClaimTypes.NameIdentifier, !String.IsNullOrEmpty(usuario.LoginName) ?EncryptDecryptService.EncryptWithSaltHash(usuario.LoginName,ConfigurationManager.AppSettings[Constantes.KEY_ENCRYPTION_WITHOUT_HASH].ToString()) : string.Empty),
                new Claim(ClaimTypes.Email, !String.IsNullOrEmpty(usuario.Email) ? EncryptDecryptService.EncryptWithSaltHash(usuario.Email,ConfigurationManager.AppSettings[Constantes.KEY_ENCRYPTION_WITHOUT_HASH].ToString()) : string.Empty),
