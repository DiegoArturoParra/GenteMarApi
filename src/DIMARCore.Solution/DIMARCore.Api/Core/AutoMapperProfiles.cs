    ...
    public class AutoMapperProfiles
    {
        ...
        public static IMapper CreateMapper()
        {
            var mapperConfiguration = new MapperConfiguration(cfg =>
            {
                ...
                cfg.CreateMap<GENTEMAR_CARGO_TITULO, CargoTituloDetalleDTO>()
               ...
               .ReverseMap();
                ...
                cfg.CreateMap<RelacionCargosReglaDTO, CargosTitulo>()
                ...
                cfg.CreateMap<GENTEMAR_DATOSBASICOS, CrearDatosBasicosDTO>()
                ...
                cfg.CreateMap<LicenciaDTO, GENTEMAR_LICENCIAS>()
                 ...
                 .ForMember(ent => ent.id_licencia_titulo, dto => dto.MapFrom(s => s.IdLicenciaTitulo)) 
                 .ReverseMap();
               ...
               .ForMember(ent => ent.activo, dto => dto.MapFrom(s => s.Activo));
                ...
                cfg.CreateMap<CrearEstupefacienteDTO, GENTEMAR_ANTECEDENTES>()
                ...
                cfg.CreateMap<ObservacionEntidadVciteDTO, GENTEMAR_EXPEDIENTE_OBSERVACION_ANTECEDENTES>()
