...
namespace DIMARCore.Api.Controllers
{
    ...
    public class ObservacionesController : BaseApiController
    {
        ...
        [HttpGet]
        [Route("titulos/{id}")]
        [AuthorizeRolesFilter(RolesEnum.GestorSedeCentral, RolesEnum.AdministradorGDM, RolesEnum.Capitania, RolesEnum.ASEPAC, RolesEnum.Consultas)]
        ...
        [AuthorizeRolesFilter(RolesEnum.GestorVCITE, RolesEnum.JuridicaVCITE, RolesEnum.AdministradorVCITE, RolesEnum.ConsultasVCITE)]
        ...
        [AuthorizeRolesFilter(RolesEnum.JuridicaVCITE, RolesEnum.AdministradorVCITE, RolesEnum.GestorVCITE)]
