...
namespace DIMARCore.Api.Controllers
{
    ...
    public class BaseApiController : ApiController
    {
        ...
        {
            string rutaInicial = ConfigurationManager.AppSettings[Constantes.PATH_REPOSITORIO_ARCHIVOS];
            var path = System.Web.HttpContext.Current.Server.MapPath($"~/{rutaInicial}");
            return path;
        }
