...
namespace DIMARCore.Api.Controllers.Estupefacientes
{
    ...
    public class ObservacionEntidadEstupefacienteController : BaseApiController
    {
        ...
        [ResponseType(typeof(List<DetalleExpedienteObservacionVciteDTO>))]
        [HttpGet]
        ...
        [AuthorizeRolesFilter(RolesEnum.AdministradorVCITE, RolesEnum.JuridicaVCITE)]
        public async Task<IHttpActionResult> CrearMasivo([FromBody] ObservacionesEntidadVciteEdicionMasivaDTO observacionesPorEntidad)
        {
            var data = Mapear<IList<ObservacionEntidadVciteDTO>, IList<GENTEMAR_EXPEDIENTE_OBSERVACION_ANTECEDENTES>>(observacionesPorEntidad.ObservacionesPorEntidad);
        ...
        {
            var data = Mapear<ObservacionEntidadVciteDTO, GENTEMAR_EXPEDIENTE_OBSERVACION_ANTECEDENTES>(obj.ObservacionPorEntidad);
        ...
        [AuthorizeRolesFilter(RolesEnum.AdministradorVCITE, RolesEnum.JuridicaVCITE)]
        public async Task<IHttpActionResult> EdicionParcialDeEstupefacientesIds([FromBody] EdicionMasivaPartialEstupefacientesDTO observacionDeEstupefacientes)
        {
        ...
        [AuthorizeRolesFilter(RolesEnum.AdministradorVCITE, RolesEnum.JuridicaVCITE)]
        public async Task<IHttpActionResult> EditarMasivoDeEstupefacientesIds([FromBody] EdicionMasivaEstupefacientesDTO estupefacientes)
        {
