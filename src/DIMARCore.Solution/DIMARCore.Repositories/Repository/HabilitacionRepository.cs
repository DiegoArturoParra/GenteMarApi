...
namespace DIMARCore.Repositories.Repository
{
    public class HabilitacionRepository : GenericRepository<GENTEMAR_HABILITACION>
    {
        ...
        {
            return await _context.GENTEMAR_REGLA_CARGO_HABILITACION
                .Include(x => x.GENTEMAR_HABILITACIONES)
                .Where(x => x.id_cargo_regla == CargoReglaId && x.GENTEMAR_HABILITACIONES.activo == Constantes.ACTIVO)
