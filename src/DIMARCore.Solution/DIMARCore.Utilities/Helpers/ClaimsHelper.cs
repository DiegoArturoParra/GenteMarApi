        ...
        public static int GetLoginId()
        {
            ...
            try
            {
                ...
                if (claimsIdentity != null)
                {
                    ...
                    usuarioId = claim == null ? 0 : int.Parse(EncryptDecryptService.DecryptWithSaltHash(claim.Value,
                                                            ConfigurationManager.AppSettings[Constantes.KEY_ENCRYPTION_WITHOUT_HASH].ToString()));
                }
            }
            catch (Exception ex)
            {
        ...
        public static string GetLoginName()
        {
            ...
            try
            {
                ...
                if (claimsIdentity != null)
                {
                    ...
                    loginName = claim == null ? "Anonimo" : EncryptDecryptService.DecryptWithSaltHash(claim.Value,
                                                            ConfigurationManager.AppSettings[Constantes.KEY_ENCRYPTION_WITHOUT_HASH].ToString());
                }
            }
            catch (Exception ex)
        ...
        public static string GetEmail()
        {
            ...
            try
            {
                ...
                if (claimsIdentity != null)
                {
                    ...
                    email = claim == null ? "Anonimo" : EncryptDecryptService.DecryptWithSaltHash(claim.Value,
                                                            ConfigurationManager.AppSettings[Constantes.KEY_ENCRYPTION_WITHOUT_HASH].ToString());
                }
            }
            catch (Exception ex)
