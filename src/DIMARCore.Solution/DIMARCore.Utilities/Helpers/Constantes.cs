namespace DIMARCore.Utilities.Helpers
{
    public class Constantes
    {
        ...
        public const string PATH_REPOSITORIO_ARCHIVOS = "PathFiles";
        ...
        public const string TRAMITE_PERMISO_ESPECIAL_PRACTICAJE = "PERMISO ESPECIAL NAVEGACION PRACTICAJE";
        ...
        public const string PREVISTAFIRMADA = "Documento Firmado";
        ...
        public const string KEY_ENCRYPTION_WITHOUT_HASH = "NameHash";
        public const string KEY_ENCRYPTION_REQUEST = "EncryptKeyRequest";
        public const string IV_ENCRYPTION_REQUEST = "EncryptIVRequest";
        ...
        public const string LOGO_LICENCIA = "Imagenes/logo-1.png";
        public const string LOGO_TITULO = "Imagenes/escudo.png";
        ...
        public const string VARIABLE_LIMITANTES = "{Limitantes}";
        public const string VARIABLE_NINGUNA = "Ninguna";
        public const string SENOR = "SEÑOR";
        public const string SENORA = "SEÑORA";
