...
namespace GenteMarCore.Tests.Utilities.Helpers
{
    [TestClass]
    public class ReutilizablesTest
    {
        ...
        {
            // Arrange
            string rutaNombreArchivo = AppDomain.CurrentDomain.BaseDirectory.Insert(AppDomain.CurrentDomain.BaseDirectory.Length, $"\\{TestSetup.RutaInicial}\\Titulo.html");
        ...
        {
            // Arrange
            string filePath = AppDomain.CurrentDomain.BaseDirectory.Insert(AppDomain.CurrentDomain.BaseDirectory.Length, $"\\{TestSetup.RutaInicial}\\{TestSetup.NombreArchivo}");
        ...
        public void GuardarArchivoDeBytes_WhenGivenValidInput_ShouldReturnOkResponseAndCorrectFilePath()
        {
            ...
            string rutaImagen = AppDomain.CurrentDomain.BaseDirectory.Insert(AppDomain.CurrentDomain.BaseDirectory.Length, $"\\{TestSetup.RutaInicial}\\{TestSetup.NombreArchivo}");

            // Lee la imagen como un arreglo de bytes
            byte[] archivoBytes = File.ReadAllBytes(rutaImagen);
            // Act
            Respuesta respuesta = Reutilizables.GuardarArchivoDeBytes(archivoBytes, TestSetup.RutaInicial, TestSetup.RutaModuloTipoDocumento, TestSetup.NombreArchivo);
        ...
        public void EliminarArchivo_WhenGivenValidPaths_ShouldReturnOkResponse()
        {
            ...
            string filePath = AppDomain.CurrentDomain.BaseDirectory.Insert(AppDomain.CurrentDomain.BaseDirectory.Length, $"\\{TestSetup.RutaInicial}");
