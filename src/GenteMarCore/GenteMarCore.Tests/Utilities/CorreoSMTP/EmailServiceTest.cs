...
namespace GenteMarCore.Tests.Utilities.CorreoSMTP
{
    [TestClass]
    public class EmailServiceTest
    {
        ...
        public void Setup()
        {
            _password = EncryptDecryptService.GenerateDecrypt(_password);
            _from = EncryptDecryptService.GenerateDecrypt(_from);
