...
namespace GenteMarCore.Entities
{
    public partial class GenteDeMarCoreContext : DbContext
    {
        ...
        public virtual DbSet<GENTEMAR_AUTENTICACION> GENTEMAR_AUTENTICACION { get; set; }
        #endregion
        ...
        public virtual DbSet<ViewGenteMarMultasPorUsuario> VIEW_MULTAS_USUARIO { get; set; }
        #endregion
        ...
        private void ProcesarAuditoria()
        {
                         ...
                         .Where(e => e.State == EntityState.Added && e.Entity is GENTEMAR_CAMPOS_AUDITORIA))
            {
                ...
                entidad.LoginCreacionId = entidad.LoginCreacionId > 0 ? entidad.LoginCreacionId : usuarioId;
                entidad.FechaCreacion = DateTime.Now;
                entidad.LoginModificacionId = entidad.LoginModificacionId > 0 ? entidad.LoginModificacionId : usuarioId;
            }
