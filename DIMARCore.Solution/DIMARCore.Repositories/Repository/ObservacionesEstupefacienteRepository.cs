...
{
    public class ObservacionesEstupefacienteRepository : GenericRepository<GENTEMAR_OBSERVACIONES_ANTECEDENTES>
    {
        ...
        {
            var query = await (from observaciones in _context.GENTEMAR_OBSERVACIONES_ANTECEDENTES
                               where observaciones.id_antecedente == id
