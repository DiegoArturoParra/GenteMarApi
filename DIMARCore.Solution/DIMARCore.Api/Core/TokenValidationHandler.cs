...
namespace DIMARCore.Api.Core
{
    ...
    internal class TokenValidationHandler : DelegatingHandler
    {
        ...
        protected override Task<HttpResponseMessage> SendAsync(HttpRequestMessage request, CancellationToken cancellationToken)
        {
            ...
            // var registroTokenAutenticacion;
            ...
            try
            {
                ...
                tokenActivo = true;
                // EJEMPLO
                ////registroTokenAutenticacion = (new StmAutenticacionBO()).Get(t => t.Token == token);
            ...
            if (statusCode == HttpStatusCode.Unauthorized && existeToken && tokenActivo)
            {
                ...
                try
                {
                    ...
                    // EJEMPLO
                    ////var resultadoDesactivar = (new StmAutenticacionBO()).DesactivarToken(registroStmAutenticacion, AutenticacionConfig.COMENTARIO_FINALIZACION_VALIDACION_SISTEMA);
        ...
        /// <summary>
        /// Valida si el id de la aplicación se encuentra en el encabezado de la solicitud
        /// </summary>
        /// <param name="request">Solicitud</param>
        /// <param name="idAplicacion">Id de la aplciación en formato cadena</param>
        /// <returns>Retorna si se encontro el id de la aplicación</returns>
        private static bool TryRetrieveIdAplicacion(HttpRequestMessage request, out string idAplicacion)
        {
